(function () {
	...
	var buildInfo = {
		...
		days: function () {
			return __(["domingo", "lunes", "martes", "miércoles", "jueves", "viernes", "sábado"]);
		},
		dayAbbr: function () {
			return __(["Dom", "Lun", "mar", "Mie", "Jue", "Vie", "Sab"]);
		},
		dayShortNames: function () {
			return __(["Dom", "Lun", "mar", "Mie", "Jue", "Vie", "Sa"]);
		},
		dayFirstLetters: function () {
			return __(["S_Sun_Initial", "M_Mon_Initial", "T_Tues_Initial", "W_Wed_Initial", "T_Thu_Initial", "F_Fri_Initial", "S_Sat_Initial"]);
		},
		months: function () {
			return __(["enero", "febrero", "marzo", "abril", "Mayi", "Junio", "Julio", "Agosto", "Setiembre", "Octobre", "Noviembre", "Diciembre"]);
		},
		monthAbbr: function () {
	...
	$D.i18n = {
		...
		setLanguage: function (code, force, cb) {
			var async = false;
			if (force || code === "es" || (!!Date.CultureStrings && !!Date.CultureStrings[code])) {
				lang = code;
