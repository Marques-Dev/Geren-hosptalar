...
#buscar{
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-warning btn-print" href="cita_agregar.php"    style="height:25%; width:15%; font-size: 12px " role="button">REGISTRAR RECEITA</a>
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> LISTA RECEITAS</h3>
                </div><!-- /.box-header -->
...
<a class="btn btn-primary btn-print" href="<?php  echo "../cita/eliminar_cita.php?id_cita=$id_cita";?>"  onClick="return confirm('Tem certeza que quer apagar a receita?');"  role="button">Deletar</a>
      <?php
