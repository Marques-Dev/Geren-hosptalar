...
<td><?php echo $row['usuario'];?></td>
  <td><?php echo $row['tipo'];?></td>      
    <td><?php echo $row['correo'];?></td>                                      
                      ...
                      ?>
  <a class="small-box-footer btn-print"  href="<?php  echo "eliminar_usuario.php?cid=$cid";?>" onClick="return confirm('Tem certeza que quer apagar o usuario selecionado?');"><i class="glyphicon glyphicon-remove" ></i></a>
